...
public class AddStock extends AppCompatActivity {
    ...
    public void itemIdNotEntered(){
        Toast.makeText(this,"Vă rugăm să introduceți ID-ul articolului: ",Toast.LENGTH_SHORT).show();
    }

    public void quantityNotEntered(){
        Toast.makeText(this,"Introduceti cantitatea pentru adaugat: ",Toast.LENGTH_SHORT).show();
    }

    public void invalidItemId(){
        Toast.makeText(this,"ID incorect.",Toast.LENGTH_SHORT).show();
    }

    public void showSuccess() {
        Toast.makeText(this,"Stoc actualizat cu succes.",Toast.LENGTH_SHORT).show();
    }
