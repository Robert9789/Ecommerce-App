...
public class SmartWatch extends AppCompatActivity {
    ...
    String details[]={"Smart Watch 1","Smart Watch 2","Smart Watch 3","Smart Watch 4"};
    int[] prices={799,1249,599,699};
    ...
    public void onBackPressed(){
        ...
        final String sph=getIntent().getStringExtra("PHONE");
        final String spa=getIntent().getStringExtra("PASSWORD");
        Intent intent=new Intent(SmartWatch.this, ElectronicsDevices.class);
