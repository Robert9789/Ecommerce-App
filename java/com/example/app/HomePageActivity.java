...
Button clothing,electronics,books,otherItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ca.equals("LoginPage"))
            Toast.makeText(this,"Buna ziua ,"+sna+"!",Toast.LENGTH_SHORT).show();
        else if(ca.equals("PlaceOrder"))
            Toast.makeText(this,"Comanda a fost plasata cu succes!",Toast.LENGTH_LONG).show();
        clothing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(HomePageActivity.this, ElectronicsPlus.class);
