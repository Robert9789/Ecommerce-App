...
public class ComputerCPU extends AppCompatActivity {

    private RecyclerView recyclerView;
    int[] images={R.drawable.w0,R.drawable.w1,R.drawable.w2,R.drawable.w3,R.drawable.w4,R.drawable.w5};
    String details[]={"Placa de baza ","Placa video","CPU i5","CPU i7","CPU i9","AMD CPU"};
    int[] prices={999,1299,4159,1899,2949,1499};
    ...
    public void onBackPressed(){
        ...
        final String sph=getIntent().getStringExtra("PHONE");
        final String spa=getIntent().getStringExtra("PASSWORD");
        Intent intent=new Intent(ComputerCPU.this,HomePageActivity.class);
