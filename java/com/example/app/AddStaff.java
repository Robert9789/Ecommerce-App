...
static DatabaseReference databaseStaff;
    ...
    public void registerStaff(){
        ...
        if(TextUtils.isEmpty(name))
            ...
            Toast.makeText(this,"Parola introdusa nu corespunde cu parola contului! ",Toast.LENGTH_SHORT).show();
        else{
            String id=databaseStaff.push().getKey();
            StaffReg staffReg=new StaffReg(name,pass,id);
            databaseStaff.child(id).setValue(staffReg);
            Toast.makeText(this,"Angajat inregistrat!",Toast.LENGTH_SHORT).show();
        }
    }
